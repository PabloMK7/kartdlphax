...
#define ROPKIT_LINEARMEM_WORKBUF ROPKIT_LINEARMEM_BUF
...
#ifdef ROPKIT_ENABLETERMINATE_THREADS
@ Set the flag for terminating the GSP thread.
ROPMACRO_WRITEWORD GSPTHREAD_OBJECTADDR+0x77, 0x1
ROPMACRO_WRITEWORD UDSTHREAD_OBJECTADDR+0x60, 0x1
ROPMACRO_WRITEWORD NEX_TRANSPORT_BUFFER_RUN1, 0x1
ROPMACRO_WRITEWORD NEX_TRANSPORT_BUFFER_RUN2, 0x1
ROPMACRO_WRITEWORD NET_THREAD_RUN, 0x0
ROPMACRO_WRITEWORD KD_THREAD_RUN, 0x0
CALLFUNC_NOARGS DSP_FINALIZE
#endif

@ Wait 2.0s for the threads to finish.
CALLFUNC_R0R1 svcSleepThread, 2000000000, 0
